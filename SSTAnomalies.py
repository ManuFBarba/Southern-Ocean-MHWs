...
outfile = r'C:\ICMAN-CSIC\MHW_ANT\datasets_40\MHW_metrics\MHW_metrics_full\SSTA_1982_2015_2021'
...
outfile = r'C:\ICMAN-CSIC\MHW_ANT\datasets_40\MHW_metrics\MHW_metrics_full\SSTA_ts'
...
outfile = r'C:\ICMAN-CSIC\MHW_ANT\datasets_40\MHW_metrics\MHW_metrics_full\Aver_SSTA_1982_2021'
...
outfile_periods = r'C:\ICMAN-CSIC\MHW_ANT\datasets_40\MHW_metrics\MHW_metrics_full\SSTA_periods'
...
fig.tight_layout()
dfig=r'C:\ICMAN-CSIC\MHW_ANT\Figures_MHW'
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\Mean_SST_1982_2021.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\Mean_SST_1982_2021_hq.png'
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\SSTA_2015_2021.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\SSTA_2015_2021_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\Max_SSTA_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
sst_grad.to_netcdf('C:\ICMAN-CSIC\MHW_ANT\datasets_40\SST_trends/SST_trends.nc', encoding=encoding)
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\SST_trends.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\SST_trends_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
sst_grad.to_netcdf('C:\ICMAN-CSIC\MHW_ANT\datasets_40\SST_trends/Max_SSTA_trends.nc', encoding=encoding)


##Reading the previously saved Max SSTA trends Dataset
ds_trend = Dataset(r'C:\ICMAN-CSIC\MHW_ANT\datasets_40\SST_trends/Max_SSTA_trends.nc')
...
p1 = plt.contourf(lon, lat, Max_SSTA_trends.T, levels, cmap=cmap, extend='both', transform=ccrs.PlateCarree()) 
