...
#SST
ds_sst = xr.open_mfdataset(r'.\SST\*.nc', parallel=True)
...
ENSO = pd.read_excel (r'.\Climate Modes\ENSO34_Index.xlsx', header=None)
SAM = pd.read_excel (r'.\Climate Modes\SAM_Index_Monthly.xlsx', header=None)
TSA = pd.read_excel (r'.\Climate Modes\TSA_Index.xlsx', header=None)
...
outfile = r'.\Max_SSTA_ONI_Pacific.png'
...
outfile = r'.\Max_SSTA_ONI_Atlantic.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_ONI_Indian.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_SAMI_Pacific.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_SAMI_Atlantic.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_SAMI_Indian.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_TSAI_Pacific.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_TSAI_Atlantic.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'.\Max_SSTA_TSAI_Indian.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
