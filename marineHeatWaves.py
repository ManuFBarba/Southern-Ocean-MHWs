...
def detect(t, temp, climatologyPeriod=[1982, 2011], pctile=95, windowHalfWidth=5, smoothPercentile=True, smoothPercentileWidth=30, minDuration=5, joinAcrossGaps=True, maxGap=2, maxPadLength=False, coldSpells=False, alternateClimatology=False, Ly=False):
    '''
    ...
    if (climatologyPeriod[0] == None) or (climatologyPeriod[1] == None):
