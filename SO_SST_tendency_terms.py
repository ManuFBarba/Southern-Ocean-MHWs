...
# Load datasets -----------------------------------------------------------
## 1982-2021
ds_onset = xr.open_dataset(r'./Onset_Phase_1982_2021.nc').squeeze()
ds_decay = xr.open_dataset(r'./Decay_Phase_1982_2021.nc').squeeze()
## 500-yr preindustrial Climatological mean
ds_onset_clim = xr.open_dataset(r'./Onset_Phase_Climatological_Preindustrial.nc').squeeze()
ds_decay_clim = xr.open_dataset(r'./Decay_Phase_Climatological_Preindustrial.nc').squeeze()
...
outfile = r'.\Temp_Tendency_Budgets_ESM2M.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight')
...
outfile = r'.\Temp_Tendency_Budgets_ESM2M_Cntrl.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight')
...
outfile = r'.\Temp_Tendency_Budgets_ESM2M_PeriodDiff.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight')
###############################################################################
...
file = r'.\Mean_contribution_heat_budget_data_matrix_pi_control_simulation'
data_matrix_piControl = np.load(file+'.npy')

file = r'.\Mean_contribution_heat_budget_data_matrix_1982_2021'
...
outfile = r'.\Temperature_Tendency_Budgets_Table.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight')
