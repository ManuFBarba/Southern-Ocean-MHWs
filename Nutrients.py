...
ds = xr.open_mfdataset(r'.\Nutrients\*.nc', parallel=True)
...
Si_grad.attrs['Publication'] = "Dataset created for Fernández-Barba. et. al. 2024: \n "
...
Si_grad.to_netcdf('.\Si_1994_2015_trends.nc', encoding=encoding)


#Si#
##Reading the previously saved Si trends Dataset
ds_trend = Dataset(r'.\Si_1994_2015_trends.nc')
...
outfile = r'.\Si_trends_2015_2021.png'
...
no3_grad.attrs['Publication'] = "Dataset created for Fernández-Barba. et. al. 2024: \n "
...
no3_grad.to_netcdf('./NO3_2015_2021_trends.nc', encoding=encoding)


##Reading the previously saved CHL trends Dataset
ds_trend = Dataset(r'./NO3_1994_2015_trends.nc')
...
ds_trend = Dataset(r'./NO3_2009_2015_trends.nc')
...
ds_trend = Dataset(r'./NO3_2015_2021_trends.nc')
...
outfile = r'.\NO3_trends_2015_2021.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
po4_grad.attrs['Publication'] = "Dataset created for Fernández-Barba. et. al. 2024: \n "
...
po4_grad.to_netcdf('./PO4_2015_2021_trends.nc', encoding=encoding)


##Reading the previously saved PO4 trends Dataset
ds_trend = Dataset(r'./PO4_1998_2015_trends.nc')
...
ds_trend = Dataset(r'./PO4_2015_2021_trends.nc')
...
outfile = r'.\PO4_trends_2015_2021.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)