...
#for i in range(31):
    ...
    #OUTPUT_FILENAME = 'GLORYS_bottomT_T_MLD'
    #OUTPUT_FILENAME = 'CHL_Canary'
    #OUTPUT_FILENAME = r'MedSea_Temperature'
    OUTPUT_FILENAME = r'Daily_CHL_NPP'
