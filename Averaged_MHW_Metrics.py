...
ds_SAT = xr.open_dataset(r'.\ERA5_1982-2021_T2M_ANT.nc')
...
ds_SIC = xr.open_mfdataset(r'.\Sea_Ice_Conc_bimensual\*.nc')
...
axs[1].plot(time_1982_2015, res_sic_mar_1982_2015.intercept + res_sic_mar_1982_2015.slope*time_1982_2015, 'y--', linewidth=2)
axs[1].plot(time_2015_2021, res_sic_mar_2015_2021.intercept + res_sic_mar_2015_2021.slope*time_2015_2021, 'y--', linewidth=2)
