...
outfile = r'.\Mean_SIF_1982_2021.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
SIC_grad.attrs['Publication'] = "Dataset created for Fernández-Barba. et. al. 2024: \n "
...
SIC_grad.to_netcdf(r'./SIC_1982_2021_trends.nc', encoding=encoding)
...
ds_trend = Dataset(r'./SIC_1982_2021_trends.nc')
...
ds_trend = Dataset(r'./SIC_1982_2015_trends.nc')
...
ds_trend = Dataset(r'./SIC_2009_2015_trends.nc')
...
ds_trend = Dataset(r'./SIC_2015_2021_trends.nc')
...
outfile = r'.\SIC_trends_1982_2021.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
###################################################
# Plotting the South Polar Stereo SIC contour map # ## Supplementary Figure S2
###################################################
...
outfile = r'.\SIC_contour_1982_2021.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
