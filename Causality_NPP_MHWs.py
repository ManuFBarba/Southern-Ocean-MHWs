...
## Monthly DS
ds_SST = xr.open_dataset(r'./Monthly_SST.nc')
SST = ds_SST.analysed_sst

ds_Max_SSTA = xr.open_dataset(r'./Max_SSTA_monthly.nc')
Max_SSTA = ds_Max_SSTA.transpose('lon', 'lat', 'time')
Max_SSTA = Max_SSTA.analysed_sst 

ds_SIC = xr.open_dataset(r'./SIC_monthly.nc')
...
np.save(r'.\Causality_CCM_outputs/MaxSSTA_to_MLD.npy', MaxSSTA_to_MLD)
np.save(r'.\Causality_CCM_outputs/MLD_to_MaxSSTA.npy', MLD_to_MaxSSTA)



## Loading previously processed causality matrices
SST_to_NPP = np.load(r'./SST_to_NPP.npy')
NPP_to_SST = np.load(r'./NPP_to_SST.npy')

MaxSSTA_to_NPP = np.load(r'./MaxSSTA_to_NPP.npy')
NPP_to_MaxSSTA = np.load(r'./NPP_to_MaxSSTA.npy')

SIC_to_NPP = np.load(r'./SIC_to_NPP.npy')
NPP_to_SIC = np.load(r'./NPP_to_SIC.npy')

MLD_to_NPP = np.load(r'./MLD_to_NPP.npy')
NPP_to_MLD = np.load(r'./NPP_to_MLD.npy')
...
outfile = r'.\EDM_CCM_NPPxmapMLD.png'
