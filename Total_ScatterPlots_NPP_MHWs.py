...
# sst_anom.to_netcdf(r'.\SSTA_SO.nc')

ds = xr.open_dataset(r'.\SSTA_SO.nc')
...
outfile = r'.\NPP_Max_SSTA_PAC.png'
...
outfile = r'.\NPP_MHWCumInt_IND.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
