...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Dur.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Dur_hq.png'
...
cbar.ax.tick_params(axis='y', size=10, direction='in', labelsize=35) 
cbar.ax.minorticks_off()
cbar.ax.get_yaxis().set_ticks([-5,-2.5,0,2.5,5])
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Dur_tr.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Dur_tr_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
#cmap=plt.cm.RdBu_r  
#cmap = 'Spectral_r'
levels = [1,1.25,1.5,1.75,2,2.25,2.5]
p1 = plt.contourf(lon, lat, MHW_cnt+mask, levels, cmap=plt.cm.YlOrRd, extend='both', transform=ccrs.PlateCarree()) 
cbar = plt.colorbar(p1, shrink=0.8, extend ='both')
cbar.ax.tick_params(axis='y', size=10, direction='in', labelsize=35) 
cbar.ax.minorticks_off()
cbar.ax.get_yaxis().set_ticks([1, 1.5, 2, 2.5])
#p1 = plt.pcolormesh(lon, lat, MHW_dur_tr, vmin=-2, vmax=2, cmap=cmap, transform=ccrs.PlateCarree())
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Freq.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Freq_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
cbar.ax.tick_params(axis='y', size=10, direction='in', labelsize=35) 
cbar.ax.minorticks_off()
cbar.ax.get_yaxis().set_ticks([-1.5, -1, -0.5, 0, 0.5, 1, 1.5])
#p1 = plt.pcolormesh(lon, lat, MHW_dur_tr, vmin=-2, vmax=2, cmap=cmap, transform=ccrs.PlateCarree())
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Freq_tr.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Freq_tr_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Max_SSTA_tr.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_Max_SSTA_tr_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
p1 = plt.contourf(lon, lat, MHW_cum+mask, levels, cmap=plt.cm.YlOrRd, extend='both', transform=ccrs.PlateCarree()) 
cbar = plt.colorbar(p1, shrink=0.8, extend ='both')
cbar.ax.tick_params(axis='y', size=10, direction='in', labelsize=35) 
cbar.ax.minorticks_off()
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_CumInt.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_CumInt_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
#cbar.ax.get_yaxis().set_ticks([-1, -0.5, -0.25, 0, 0.25, 0.5, 1])
...
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_CumInt_tr.png'
fig.savefig(outfile, dpi=300, bbox_inches='tight', pad_inches=0.5)
outfile = r'C:\Users\Manuel\Desktop\Figures_Paper_SO_MHW\MHW_CumInt_tr_hq.png'
fig.savefig(outfile, dpi=600, bbox_inches='tight', pad_inches=0.5)
...
https://github.com/cse512-18s/marine-heatwave/blob/master/data/MHWclassify.ipynb
